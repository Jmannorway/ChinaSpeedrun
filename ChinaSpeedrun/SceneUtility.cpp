...
bool cs::SceneUtility::CreateStaticTriangleCollidersFromMesh(const Mesh* const mesh)
{
    if (mesh)
    {
        ...
        {
            auto _obj = SceneManager::InstanceObject(("Collision triangle " + std::to_string(_objIndex)).c_str());
